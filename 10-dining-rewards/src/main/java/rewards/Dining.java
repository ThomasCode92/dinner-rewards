...
public class Dining {
    ...
    /**
     * Creates a new dining, reflecting an amount charged to a card by a restaurant on the date specified.
     *
    ...
    /**
     * Creates a new dining, reflecting the amount charged to a credit card by a restaurant on today's date. A
    ...
    /**
     * Creates a new dining, reflecting an amount charged to a credit card by a restaurant on the date
