...
/**
 * A single beneficiary allocated to an account. Each beneficiary has a name (e.g. Annabelle) and a
 * savings balance tracking how much money has been saved for he or she to date (e.g. $1000).
 */
