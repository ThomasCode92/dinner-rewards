...
/**
 * Handles creating records of reward transactions to track contributions made to accounts for
...
public interface RewardRepository {
     ...
     * @return a reward confirmation object that can be used for reporting and to look up the reward
