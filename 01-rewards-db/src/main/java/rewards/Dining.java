...
/**
 * A dining event that occurred, which represents a charge made to a credit card by a merchant on a specific date.
 * <p>
...
public class Dining implements Serializable {
    ...
    /**
     * Creates a new dining, reflecting an amount charged to a card by a merchant on the date specified.
     *
    ...
    /**
     * Creates a new dining, reflecting an amount charged to a credit card by a merchant on today's date. A
    ...
    /**
     * Creates a new dining, reflecting an amount charged to a credit card by a merchant on the date specified.
